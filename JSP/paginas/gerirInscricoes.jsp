...
<%
	...
	if(session.getAttribute("user") != null && session.getAttribute("id") != null && (tipoUtilizador == ADMINISTRADOR || tipoUtilizador == DOCENTE) ){
...
%>
			...
			%>
					...
					%>
									...
									<td><a href = 'mostraInscricoes.jsp?curso=<%= idCurso %>'> Gerir Inscrições </a></td>
								</tr>
