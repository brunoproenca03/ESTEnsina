          ...
          >
            ...
            >
              <ul class="navbar-nav align-items-center mx-auto">
                <li class="nav-item">
                  <a class="nav-link link px-3" href="index.jsp"
                    ><span>Home</span></a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link link px-3" href="contacto.jsp"
              ...
              >
                <li class="nav-item">
                  <a class="nav-link px-0" href="PaginaUtilizador.jsp"
                    ><button
                ...
                <li class="nav-item">
                  <a class="nav-link px-0" href="login.jsp"
                    ><button
                      class="btn primary-color btn-round btn-outline border-0"
                      style="padding: 12px 14px"
                    >
            ...
            >
              ...
              <div class="card-content col-md-8" style="padding: 40px 30px">
                ...
                <p class="paragraph second-text-color" style="margin-top: 15px">
                  ...
                  ainda é possível comprar diversos produtos, desde produtos domesticos a 
