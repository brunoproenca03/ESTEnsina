          ...
          <nav class="navbar navbar-expand-lg navbar-light w-100 position-static" id="">
            ...
            <div class="collapse navbar-collapse py-4 py-lg-0 ms-xl-4 mt-4 mt-lg-0" id="navbarSupportedContent">
              <ul class="navbar-nav align-items-center mx-auto">
                <li class="nav-item">
                  <a class="nav-link link px-3" href="index.jsp"><span>Home</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link link px-3" href="contacto.jsp"><span>Contacto</span></a>
                </li>
              </ul>
              <ul class="navbar-nav ms-auto align-items-center mt-4 mt-lg-0 me-lg-4">
                
                <li class="nav-item">
                  <a class="nav-link px-0" href="PaginaUtilizador.jsp"><button class="btn primary-color btn-round btn-outline border-0" style="padding: 12px 14px"><span class="small ms-1">Página Utilizador</span></button></a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link px-0" href="login.jsp"><button class="btn primary-color btn-round btn-outline border-0" style="padding: 12px 14px">
                    ...
                    <%
                            ...
                            if (tipoUtilizadorStr != null) {
                                ...
                                if (session.getAttribute("user") != null && session.getAttribute("id") != null && (tipoUtilizador != ALUNO_NAO_VALIDADO || tipoUtilizador != VISITANTE) ) {
                                  ...
                                  if (userName != null) {
                                      out.println("<span class='small ms-1'>" + userName + "</span>");
                                  }
  
                                } else {
                                  out.println("<span class='small ms-1'>Login / Registar</span>");
                                } 
                            } else {
                                if (session.getAttribute("user") == null && session.getAttribute("id") == null && tipoUtilizadorStr == null){
                                    out.println("<span class='small ms-1'>Login / Registar</span>");
                                }
                            }
