...
>
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel=
"stylesheet">
  <style>
     body {
...
%>		
		<div id='corpo'>
			...
			<div class='botaoCorpo'>
					<form action='mostraInscricoes.jsp'>
						<input type='submit' value='Ver Inscrições' id='btCorpo'>
					</form>
			</div>
			<div class='botaoCorpo'>
					<form action='verTodosCursos.jsp'>
