...
- **Course Management**: 
  ...
  - Categorize courses by subjects or levels.
  - View course details, schedules, and instructors.

- **User Enrollment**: 
  - User registration and login functionalities.
  - Enroll in courses with simple user interface.
  - Monitor enrollment status and history.

- **Database Management**: 
  - Utilizes **MySQL** for backend data storage, ensuring secure and efficient data handling.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/<owner>/ESTEnsina.git
   ```
